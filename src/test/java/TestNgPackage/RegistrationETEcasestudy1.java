	  ...
	  public void f(String fname, String lname,String email, String pass, String upass) throws Exception {
		  ...
		  ExtentReports extent=new ExtentReports();
			...
			else
			{
				...
				File dfile = new File("D:\\verifyimages\\verify.png");
			...
			else
			{
				...
				File dfile1 = new File("UserFirstverify.png");
			...
			else
			{
				Thread.sleep(3000);
				File sfile1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
				File dfile1 = new File("UserLastverify.png");
				FileUtils.copyFile(sfile1, dfile1);
				String path1 = dfile1.getAbsolutePath();
				test.fail("Username is not displayed"
						,MediaEntityBuilder
			...
			else
			{
				...
				File dfile2 = new File("D:\\verifyimages\\verify.png");
...
//		  //js.executeAsyncScript("window.scrollBy(0,document.body.scrollHeight)");
		  ...
		  /*if(obj.verifylogin())
			...
			else
			{
				...
				File dfile3 = new File("D:\\verifyimages\\verify.png");
	 ...
	 // @Parameters("Browser")
	  ...
	  public void beforeMethod() throws Exception {
		  System.out.println("This is before method");
			 InputStream input1 = new FileInputStream("C:\\Users\\rohan.chari\\eclipse-workspace\\JAN2024_Selenium\\EcommersewebsiteData.properties");
	  ...
	  public Object[][] dp() throws Exception {
		  File f1 = new File("D:\\LumaData.xlsx");
